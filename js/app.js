...
if(s==='quiz')c=quiz(onmagam.onmagamQuizItems,'onmagamQuiz',sectionCopy('onmagam','quiz').title||'',sectionCopy('onmagam','quiz').description||'');return shell('onmagam',`${c}${renderCmsBlocks(getSectionBlocks(project,'onmagam',s))}`)}
