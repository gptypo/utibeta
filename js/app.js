...
if(s==='quiz')c=quiz(onmagam.onmagamQuizItems,'onmagamQuiz',sectionCopy('onmagam','quiz').title||'',sectionCopy('onmagam','quiz').description||'');if(!c)c=genericSectionContent('onmagam',s);return shell('onmagam',`${c}${renderCmsBlocks(getSectionBlocks(project,'onmagam',s))}`)}
...
function helyzeteimPage(){const s=sectionFor('helyzeteim');let c='';
 ...
 if(!c)c=genericSectionContent('helyzeteim',s);return shell('helyzeteim',`${c}${renderCmsBlocks(getSectionBlocks(project,'helyzeteim',s))}`)}
