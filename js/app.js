...
if(s==='quiz')c=quiz(onmagam.onmagamQuizItems,'onmagamQuiz',sectionCopy('onmagam','quiz').title||rt.workplaceSituationsTitle||'',sectionCopy('onmagam','quiz').description||rt.workplaceSituationsDescription||'');return shell('onmagam',c)}
