...
async function fetchBaseProject(){
  ...
  return {
    schema:'utiterv-project-v5',version:manifest.version||'5.1.0',updatedAt:new Date().toISOString(),
...
export function exportModularBundle(){
  ...
  return JSON.stringify({schema:'utiterv-modular-bundle-v5',version:'5.1.0',files},null,2);
}
export {PROJECT_KEY};
